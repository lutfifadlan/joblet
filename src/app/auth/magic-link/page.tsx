    ...
    <div className="h-screen w-full flex flex-col md:flex-row">
      ...
      <div className="flex-1 h-full flex items-center justify-center bg-background dark:bg-gray-950 relative">
        ...
        >
          ...
          <h2 className="text-2xl font-bold text-center mb-6">Magic Link</h2>
          {!isSubmitted ? (
            ...
            <div className="text-center">
              <p className="mb-4">Magic link has been sent to your email if an account exists.</p>
              <p>Check your email and click the magic link to sign in.</p>
            </div>
          )}
        </motion.div>
      </div>
