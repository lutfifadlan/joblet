...
interface LeftToRightArrowProps {
  width?: number;
  height?: number;
}

const LeftToRightArrow: React.FC<LeftToRightArrowProps> = ({ width = 80, height = 80 }) => {
  ...
  let fillColor = '#0D1927'; // default for SSR
  if (mounted) {
    fillColor = resolvedTheme === 'dark' ? '#FFFFFF' : '#0D1927';
  }
  ...
  return (
    ...
    >
      <path
        ...
        fill={fillColor}
        transform="translate(2069.25 -1185.9)"
      />
    </svg>
  );
};
